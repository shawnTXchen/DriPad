...
def turnRight(value, T):
    ...
    for i in idx:
        if type(i) is not list:
            ...
            # print i
            SetVoicecoil(i[0], int(value*1.5))
            SetVoicecoil(i[1], int(value*1.5))
            time.sleep(T/4.)
            SetVoicecoil(i[0], 0)
            SetVoicecoil(i[1], 0)
...
def slightRight(value):
    for i in xrange(2):
        SetMotor(2, int(value/1.5))
        SetMotor(6, int(value/2.0))
        time.sleep(0.2)
        SetMotor(2, 0)
        SetMotor(6, 0)
...
def slightLeft(value):
    for i in xrange(2):
        SetMotor(1, int(value/1.5))
        SetMotor(5, int(value/2.0))
        time.sleep(0.2)
        SetMotor(1, 0)
        SetMotor(5, 0)
